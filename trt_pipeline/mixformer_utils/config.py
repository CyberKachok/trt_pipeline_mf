...
class Config:
    ...
    def _file2dict(filename):
        ...
        if not fileExtname == '.json':
            raise OSError('Only json type is supported now!')

        with open(filename, 'r') as json_cfg:
            cfg_dict = json.load(json_cfg)
    ...
    def __setstate__(self, state):
        super().__setattr__('_cfg_dict', state)
